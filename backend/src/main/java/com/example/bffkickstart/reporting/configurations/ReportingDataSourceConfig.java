package com.example.bffkickstart.reporting.configurations;
...
@EnableJpaRepositories(
        basePackages = "com.example.bffkickstart.reporting.repositories",
...
public class ReportingDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean kickstartRptEntityManagerFactory(
        ...
        emf.setPackagesToScan("com.example.bffkickstart.reporting.models");
